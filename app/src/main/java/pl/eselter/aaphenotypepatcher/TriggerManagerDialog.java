...
public class TriggerManagerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        StreamLogs streamLogsTriggerList =
                MainActivity.runSuWithCmd(
                        path
                                + "/sqlite3"
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            for (Integer mSelectedItem : mSelectedItems) {
                                StreamLogs streamLogsDropTrigger =
                                        MainActivity.runSuWithCmd(
                                                path
                                                        + "/sqlite3"
                                                        + " /data/data/com.google.android.gms/databases/phenotype.db"
                                                        + " 'DROP TRIGGER \""
                                                        + triggersList[mSelectedItem].toString()
                                                        + "\";'");
                                textViewLogs.append(
                                        streamLogsDropTrigger.getStreamLogsWithLabels());
                            }
                        }
                    });
        }
